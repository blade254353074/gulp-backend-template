...
<body>
        ...
        <div class="navigator">
            ...
            <ul id="menu" class="menu">
                ...
                <li class="menu-list active">
                    ...
                    <ul class="sub-menu-list">
                        <li class="active"><a href="/keeper/reserve/handle/1">未处理列表</a></li>
        ...
        <div class="app-content">
            ...
            <div id="appContent" class="main-content">
                <div class="center-block-lg" style="padding-top:30px;">
                        ...
                        <#if reserveList??>
                            ...
                            <tr data-id="${item.reserveId}">
                                ...
                                <td class="text-center">
                                    <button class="accept btn btn-success btn-sm" type="button">接受</button>
                                    <button class="ignore btn btn-danger btn-sm" type="button">忽略</button>
                                </td>
                            </tr>
                            </#list>
                        </#if>
                    ...
                    <#assign link = "/keeper/reserve/handle/">
    ...
    <script src="/assets/admin/js/page/reserve/index.js"></script>
</body>
